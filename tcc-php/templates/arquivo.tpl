							...
							<table width="100%" border="0" cellspacing="0" cellpadding="5" bordercolor="#FFFFFF" id="ApplicationAdministratorTable">
								...
								<tr>
									<td class="actionbkgrd">
										<a class="roleaction"  href="index.php?op=c_arquivo"><img width="16" height="13" hspace="8" border="0" src="img/action.gif">Criar</a>
									</td>
								</tr>
								<tr>
									<td class="actionbkgrd">
								...
								<tr>
									<td class="actionbkgrd">
										<a class="roleaction" href="#"><img width="16" height="13" hspace="8" border="0" src="img/action.gif">Visualização</a>										
									</td>
								</tr>
							</table>
						</div>
